      ...
      >
        <div className="text-center">
          ...
          <div className="mt-10 flex justify-center gap-4">
            <a
              href="#contact"
              className="inline-flex items-center px-6 py-3 rounded-md text-black font-medium transition-all hover:scale-105"
            ...
            <a
              href="#work"
              className="inline-flex items-center px-6 py-3 border text-white border-white/20 rounded-md font-medium hover:bg-white/10 transition-colors"
            >
              View Our Work
            </a>
          </div>
